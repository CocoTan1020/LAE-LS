...
def align_sequences(source_sent, target_sent):
    ...
    # print('sent_with_tags', sent_with_tags)
...
def convert_data_from_raw_files(source_file, target_file, output_file, chunk_size):
    ...
    for source_sent, target_sent in tqdm(zip(source_data, target_data)):
        ...
        # print('source_sent', source_sent)
        # print('target_sent', target_sent)
        # print('aligned_sent', aligned_sent)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--source',
                        ...
                        default='E:/BaiduSyncdisk/备份/gector-adv/data/temp_test/source5.txt')
    parser.add_argument('-t', '--target',
                        help='Path to the target file',
                        default='E:/BaiduSyncdisk/备份/gector-adv/data/temp_test/target5.txt')
    parser.add_argument('-o', '--output_file',
                        help='Path to the output file',
                        default='E:/BaiduSyncdisk/备份/gector-adv/data/temp_test/s2t.txt')
